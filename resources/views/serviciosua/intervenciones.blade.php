            ...
            <div class="panel-body">
            	<div class="row">
	            	<form method="POST" action="#" accept-charset="UTF-8" class="form-horizontal">
			            ...
			            <div class="form-group" style="margin-right: 0px;">
			                <div class="col-md-3">
			                	<button class="btn btn-primary" id="obtener_id_intervenciones" style="float: right;" disabled="true">Obtener ID de las intervenciones</button>
			                </div>
			                <div class="col-md-2">
...
<script>
	...
	$("#obtener_id_intervenciones").click(function(e){
		...
		$.ajax({
            type: 'GET',
            url: "/ajax/serviciosua/id_intervenciones/",
            dataType: 'json',
            data: data,
            contentType: 'application/json; charset=utf-8',
            success: function(response) {
            	$.each( response, function( key, columnas ) {
					$('#tipo_intervencion')
                    	...
                    	.attr("value", columnas.id)
                    	.text(columnas.descripcion)); 
				});
				$("#obtener_id_intervenciones").attr('disabled', true);
				$("#tipo_intervencion").attr('disabled', false);
	...
	$("#procesar").click(function(e){
		...
		$("#import-tabla").find('tr').each(function() {
			...
			tipo_resolucion = $("#tipo_intervencion").val();
			...
			$.ajax({
			    type:"POST",
			    url:'/ajax/serviciosua/intervenir',
			    data: data2,
			    dataType: 'json',
			    success: function(response) {
